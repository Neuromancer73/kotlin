    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : KtVisitorVoid() {
            override fun visitCallExpression(expression: KtCallExpression) {
                ...
                val resolvedCall = expression.getResolvedCall(expression.analyze())

                val parentArgument = expression.parent as? KtValueArgument ?: return
                if (!parentArgument.isNamed()) return
                parentArgument.parent.parent as? KtAnnotationEntry ?: return
